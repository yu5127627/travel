        ...
        <ul class="rm-like">
            ...
            >
                ...
                <div class="rm-list-info">
                    ...
                    <p class="rm-list-info-content" v-text="item.content"></p>
                    <p class="rm-list-info-address">
...
<style lang="stylus" scoped>
    ...
    .rm-list-info-btn{
        background-color: rgba(110,111,255,.8);
        color: white;
        padding: .01rem;
        border-radius: .06rem;
        margin-left: .3rem;
